...
public class PrintableIndexMaxHeap extends IndexMaxHeap<Comparable<Integer>> {

    public PrintableIndexMaxHeap(int capacity) {
        super(capacity);
    }
    ...
    public static void main(String[] args) {
        ...
        PrintableIndexMaxHeap maxHeap = new PrintableIndexMaxHeap(100);
        int N = 31; // 堆中元素个数
...
//            maxHeap.insert(new Integer((int) (Math.random() * M)));
        ...
        while (!maxHeap.isEmpty()) {
            System.out.println(maxHeap.extractItem());
        }
